...
var start = Date.now();
  ...
  //---
  camera = new THREE.PerspectiveCamera(100, _width/_height, 1, 1000);
  camera.position.set(0,0,16);
  //---
  renderer = new THREE.WebGLRenderer({antialias:false, alpha:false, "canvas":canvas});
...
var primitiveElement = function() {
  ...
  mat = new THREE.ShaderMaterial( {
    ...
    vertexShader: document.getElementById( 'vertexShaderPerlin3' ).textContent,
    fragmentShader: document.getElementById( 'fragmentShaderPerlin3' ).textContent
  });
  //---
